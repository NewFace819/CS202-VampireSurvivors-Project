...
private:
    ...
    sf::Texture m_charTexture;  // owns the per-character texture
...
public:
    CharacterCardWidget(TextureAtlas& atlas, const sf::Font& font, const sf::Font* boldFont, const CharacterProfile& profile, bool isUnlocked, const WeaponDataManager* weaponManager = nullptr, TextureAtlas* itemsAtlas = nullptr);
