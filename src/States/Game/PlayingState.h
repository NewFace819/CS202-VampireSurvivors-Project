...
enum class CharacterType {
    ...
    Minnah, Leda, Cosmo, Peppino, BigTrouser, MissingN0, Gains, Gyorunton, Sigma, Marrabbio, Avatar, RedDeath, Robbert, ZiAppunta, SheMoon, Santa, Gazebo, ChulaReh, SpaceDude, BatsBatsBats, Rose
};
